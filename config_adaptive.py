...
# @File    : config_adaptive.py
# @Software: PyCharm
# @Describe: Configuration for Adaptive CP-GNN (A-CP-GNN)
...
model_config = {
    ...
    # Adaptive CP-GNN specific parameters
    'adaptive_hidden_dims': [64, 32],  # Hidden dimensions for adaptive MLP
    'adaptive_dropout': 0.3,  # Dropout rate for adaptive MLP
    'use_adaptive': True,  # Enable adaptive mode
}
...
train_config = {
    ...
    'sample_workers': 8,
    'patience': 15,
    'checkpoint_path': os.path.join(config_path, 'checkpoint', data_config['dataset'] + '_adaptive'),
    
    # Adaptive training parameters
    'use_adaptive_loss': True,  # Use adaptive loss instead of k-hop specific loss
    'adaptive_loss_weight': 1.0,  # Weight for adaptive loss component
    'structural_feature_update_freq': 10,  # Update structural features every N epochs
}

evaluate_config = {
    'method': 'LR',
    'save_heat_map': True,
    'result_path': os.path.join('result', data_config['dataset'] + '_adaptive'),
    'random_state': 123,
    'max_iter': 500,
    'n_jobs': 1,
    'save_heat_map': False
